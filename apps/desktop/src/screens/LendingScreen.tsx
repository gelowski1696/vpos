...
import type { DesktopAppState, DesktopLendingDetail, DesktopLendingRecord } from '../db/schema';
          ...
          {!selectedRecord ? (
            ...
            <div className="sales-detail-stack">
              <div className="sales-detail-grid">
                ...
                <div className="customer-detail-card">
                  <span>Open Qty</span>
                  <strong>{fmtNumber(selectedRecord.total_quantity_lent - selectedRecord.total_quantity_returned)}</strong>
                </div>
              </div>
