  ...
  return (
    <>
      <main
        ...
        className="flex min-h-screen items-center justify-center bg-[radial-gradient(circle_at_12%_10%,rgba(240,200,111,0.18),transparent_35%),radial-gradient(circle_at_88%_6%,rgba(182,138,61,0.18),transparent_30%),linear-gradient(130deg,#060606,#15110b,#050505)] px-4 py-8 sm:px-6"
      >
          ...
          <form autoComplete="off" className="mt-5 space-y-3" onSubmit={onSubmit}>
            <label className="block text-sm">
              ...
              <input
                ...
                disabled={WEB_PORTAL_ACCESS_RESTRICTED}
                name="vpos_email"
            ...
            <label className="block text-sm">
              ...
              <div className="relative">
                ...
                <button
                  ...
                  className="absolute right-2 top-1/2 -translate-y-1/2 rounded-md border border-amber-300/40 px-2 py-1 text-xs text-amber-100 hover:bg-amber-300/10 disabled:cursor-not-allowed disabled:opacity-50"
                  disabled={WEB_PORTAL_ACCESS_RESTRICTED}
            ...
            <button
              ...
              disabled={WEB_PORTAL_ACCESS_RESTRICTED || loading}
              type="submit"
            >
