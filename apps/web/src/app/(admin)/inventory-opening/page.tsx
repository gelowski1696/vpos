...
export default function InventoryOpeningPage(): JSX.Element {
  ...
  return (
    <div className="space-y-4">
      ...
      {applyModalOpen ? (
        <div className="fixed inset-0 z-50 flex items-start justify-center overflow-y-auto bg-slate-900/50 p-4 sm:items-center" role="presentation">
          <div
              ...
              <div className="rounded-xl border border-slate-200 p-4 dark:border-slate-700">
                ...
                <div className="max-h-[44vh] space-y-3 overflow-y-auto pr-1">
                  {lines.map((line, index) => {
                    ...
                    return (
                      <div className="rounded-lg border border-slate-200 p-4 dark:border-slate-700" key={line.id}>
                        ...
                        <div className="grid gap-3 md:grid-cols-12">
                          ...
                          {isLpg ? (
                            ...
                            <label className="grid gap-1 text-sm md:col-span-12">
