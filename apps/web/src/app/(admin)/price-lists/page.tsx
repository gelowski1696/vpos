          ...
          >
            ...
            <div className="max-h-[calc(92vh-88px)] overflow-y-auto">
              ...
              <div className="space-y-3 p-3 md:col-span-8">
                ...
                <section className="rounded-xl border border-slate-200 p-3 dark:border-slate-700">
                  <h4 className="text-sm font-semibold text-slate-900 dark:text-slate-100">Bulk Update</h4>
                  <p className="mt-1 text-xs text-slate-500 dark:text-slate-400">Set change + target, then apply.</p>
                  <div className="mt-2 grid gap-2 md:grid-cols-12">
                    <label className="text-xs md:col-span-2">
                      <span className="mb-1 block font-medium text-slate-700 dark:text-slate-200">Change</span>
                      <select
                        className="w-full rounded-lg border border-slate-300 bg-white px-2 py-2 text-sm text-slate-900 dark:border-slate-600 dark:bg-slate-800 dark:text-slate-100"
                      ...
                      >
                        ...
                        <option value="FIXED">PHP Adjust</option>
                      </select>
                    </label>
                    <label className="text-xs md:col-span-2">
                      <span className="mb-1 block font-medium text-slate-700 dark:text-slate-200">Amount</span>
                      <input
                        className="w-full rounded-lg border border-slate-300 bg-white px-2 py-2 text-sm text-slate-900 dark:border-slate-600 dark:bg-slate-800 dark:text-slate-100"
                    ...
                    <label className="text-xs md:col-span-3">
                      <span className="mb-1 block font-medium text-slate-700 dark:text-slate-200">Update</span>
                      <select
                        className="w-full rounded-lg border border-slate-300 bg-white px-2 py-2 text-sm text-slate-900 dark:border-slate-600 dark:bg-slate-800 dark:text-slate-100"
                        onChange={(event) =>
                      ...
                      >
                        <option value="PRICE_AND_COST">Price + Cost</option>
                        <option value="PRICE_ONLY">Price</option>
                        <option value="COST_ONLY">Cost</option>
                      </select>
                    </label>
                    <label className="text-xs md:col-span-3">
